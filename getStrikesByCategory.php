...
if ($update) {
  ...
  FROM tbl_210_skills AS skills 
  JOIN tbl_210_subcategories_def AS subCatDef ON skills.subcategory_id = subCatDef.id 
  JOIN tbl_210_categories_def AS catDef ON skills.category_id = catDef.id 
  LEFT JOIN tbl_210_subcategories AS subCatTest ON subCatTest.category_id = skills.category_id AND subCatTest.subcategory_id = skills.subcategory_id AND subCatTest.goal_id = $goal_id
  ...
  FROM tbl_210_skills AS skills
  JOIN tbl_210_categories_def AS catDef
  ON skills.category_id = catDef.id
  JOIN tbl_210_subcategories_def AS subCatDef
